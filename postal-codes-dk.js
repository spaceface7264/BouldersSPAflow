// Danish Postal Code Lookup
// Contains postal codes and their corresponding cities
// Used as fallback when API endpoint is not available

const DANISH_POSTAL_CODES = {
  // Copenhagen area
  '1000': 'København K',
  '1050': 'København K',
  '1051': 'København K',
...
// Lookup function
function lookupCityByPostalCode(postalCode) {
  ...
  return DANISH_POSTAL_CODES[cleanPostalCode] || null;
}

// Export for use in other files
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { DANISH_POSTAL_CODES, lookupCityByPostalCode };
}
