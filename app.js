...
const translations = {
  ...
  'de-DE': {
    ...
    'faq.gyms.openingHours.q': 'Wie sind die Öffnungszeiten?',
    'faq.gyms.openingHours.a': 'Die Öffnungszeiten variieren zwischen den Hallen. Die aktuellen Öffnungszeiten finden Sie auf unserer Website oder durch Kontakt mit der jeweiligen Halle.',
    'faq.gyms.openingHours.intro': 'Alle Boulders-Hallen sind 361 Tage im Jahr von morgens bis abends geöffnet:',
    ...
    'faq.gyms.access.a': 'Nach abgeschlossenem Kauf besuchen Sie die ausgewählte Halle und holen Ihre Zugangskarte ab. Die Karte ist Ihr Schlüssel zu Boulders: Sie scannen sie beim Ankommen, um die Gates zu öffnen.',
    'faq.gyms.events.q': 'Gibt es Events und Aktivitäten?',
    'faq.gyms.events.a': 'Ja! Wir veranstalten regelmäßig Events, Wettbewerbe und soziale Aktivitäten in all unseren Hallen. Auf unserer Website finden Sie die kommenden Veranstaltungen.',
    'faq.gyms.gettingStarted.q': 'Wie fange ich an?',
    'faq.gyms.gettingStarted.a': 'Es gibt viele Wege einzusteigen. Wir empfehlen einen Intro- oder Fundamentals-Kurs. Sie müssen nicht mit einem Kurs starten, aber es ist eine tolle Möglichkeit, Leute kennenzulernen. Viele starten allein und finden schnell eine Community in unserer inklusiven Kletterkultur. Sie können auch unseren Einsteiger-Guide lesen.',
    'faq.membership.included.q': 'Was ist in meiner Mitgliedschaft enthalten?',
    'faq.membership.included.a': 'Ihre Mitgliedschaft beinhaltet einen kostenlosen Einführungskurs, unbegrenzten Zugang zu allen Boulders-Hallen, Nutzung aller Kletterbereiche und Einrichtungen sowie Zugang zu Events und Aktivitäten.',
    'faq.membership.blocLife.q': 'Was ist Bloc Life?',
    'faq.membership.blocLife.a': 'Bloc Life ist das Treueprogramm für Boulders-Mitglieder. Als Mitglied sind Sie automatisch dabei. Je länger Sie Mitglied sind, desto mehr Vorteile erhalten Sie - Rabatte auf Ausrüstung, Kaffee, Snacks und exklusiven Zugang zu neuen Hallen. Vorteile und Stufen werden automatisch aktualisiert.',
    'faq.membership.terms.q': 'Wie lauten die Bedingungen?',
    'faq.membership.terms.a': 'Die Mitgliedschaft ist ein fortlaufendes Abonnement mit automatischer Verlängerung. Es gibt keine Anmelde- oder Kündigungsgebühren. Die Kündigungsfrist beträgt den Rest des laufenden Monats plus 1 Monat. Die vollständigen Bedingungen finden Sie über den Link im Warenkorb.',
    'faq.membership.bindingPeriod.q': 'Gibt es eine Bindungsfrist?',
    'faq.membership.bindingPeriod.a': 'Außerhalb von Kampagnen gibt es bei Boulders-Mitgliedschaften keine Bindungsfrist. Sie können jederzeit mit Frist zum Monatsende plus einem weiteren Monat kündigen. Bei Anmeldung über eine vergünstigte Kampagne gilt eine Bindungsfrist von 3 Monaten.',
    'faq.membership.freeze.q': 'Kann ich meine Mitgliedschaft pausieren?',
    'faq.membership.freeze.a': 'Ja. Sie können Ihre Mitgliedschaft jeweils für 1-3 Monate pausieren, bis zu 3-mal pro Jahr, für 49 kr pro Pause. Während der Pause werden keine Beiträge berechnet, und die Reaktivierung ist kostenlos. Während einer Bindungsfrist kann die Pause nicht aktiviert werden.',
    'faq.membership.cancellation.q': 'Wie kündige ich meine Mitgliedschaft?',
    'faq.membership.cancellation.a': 'Sie können Ihre Mitgliedschaft jederzeit kündigen. Die Kündigungsfrist beträgt den Rest des laufenden Monats plus 1 Monat. Kontaktieren Sie medlem@boulders.dk oder melden Sie sich in Ihrem Konto an, um zu kündigen.',
    'faq.15daypass.howItWorks.q': 'Wie funktioniert der 15-Tage-Pass?',
    'faq.15daypass.howItWorks.a': 'Der 15-Tage-Pass gibt Ihnen ab dem Aktivierungsdatum 15 Tage unbegrenzten Zugang zu allen Boulders-Hallen. Perfekt, um Klettern auszuprobieren oder für einen kurzen Besuch.',
    'faq.15daypass.validity.q': 'Wie lange ist der Pass gültig?',
    'faq.15daypass.validity.a': 'Der 15-Tage-Pass ist ab dem Aktivierungsdatum 15 Tage gültig. In diesem Zeitraum haben Sie unbegrenzten Zugang zu allen Hallen.',
    'faq.15daypass.access.q': 'Welchen Zugang bekomme ich mit dem Pass?',
    'faq.15daypass.access.a': 'Mit dem 15-Tage-Pass erhalten Sie 15 Tage lang unbegrenzten Zugang zu allen Boulders-Hallen sowie zu allen Kletterbereichen und Einrichtungen. Der Pass kann nicht in eine Vollmitgliedschaft umgewandelt werden.',
    'faq.punchcard.howItWorks.q': 'Wie funktioniert die Stempelkarte?',
    'faq.punchcard.howItWorks.a': 'Die Stempelkarte gibt Ihnen pro Stempel einen (1) Eintritt in allen Boulders-Hallen. Bei jedem Hallenbesuch wird ein (1) Stempel verwendet. Die Karte ist 12 Monate gültig und kann mit anderen geteilt werden.',
    'faq.punchcard.convert.q': 'Kann ich meine Stempelkarte in eine Mitgliedschaft umwandeln?',
    'faq.punchcard.convert.a': 'Ja, Sie können Ihre Stempelkarte in eine Mitgliedschaft umwandeln. Kontaktieren Sie uns unter medlem@boulders.dk, wenn Sie umwandeln möchten.',
    'faq.punchcard.remainingClips.q': 'Was mache ich mit verbleibenden Stempeln auf meiner Stempelkarte?',
    'faq.punchcard.remainingClips.a': 'Wenn Sie noch Stempel übrig haben, aber zu einer Mitgliedschaft wechseln möchten, können Sie sie in eine Mitgliedschaft umwandeln lassen. Schreiben Sie dafür an medlem@boulders.dk. Oder verschenken Sie die restlichen Stempel an jemanden, der sie verdient.',
    'faq.punchcard.multiple.q': 'Kann ich mehrere Stempelkarten haben?',
    'faq.punchcard.multiple.a': 'Ja, Sie können eine unbegrenzte Anzahl an Stempelkarten in Ihrem Profil haben.',
    'faq.productChoice.difference.q': 'Was ist der Unterschied zwischen Mitgliedschaft, 15-Tage-Pass und Stempelkarte?',
    'faq.productChoice.difference.a': 'Die Mitgliedschaft ist ein fortlaufendes Abonnement mit unbegrenztem Zugang. Der 15-Tage-Pass gibt 15 Tage unbegrenzten Zugang - ideal zum Ausprobieren des Kletterns. Die Stempelkarte bietet in der Regel 10 Eintritte (sofern nicht anders angegeben), ist 12 Monate gültig und kann mit anderen geteilt werden.',
    'faq.productChoice.membershipBest.q': 'Wann sollte ich eine Mitgliedschaft wählen?',
    'faq.productChoice.membershipBest.a': 'Wählen Sie die Mitgliedschaft, wenn Sie mindestens einmal pro Woche klettern möchten. Sie erhalten unbegrenzten Zugang zu allen Hallen, keine Anmelde- oder Kündigungsgebühren und können jederzeit mit kurzer Frist kündigen.',
    'faq.productChoice.15daypassBest.q': 'Wann sollte ich den 15-Tage-Pass wählen?',
    'faq.productChoice.15daypassBest.a': 'Wählen Sie den 15-Tage-Pass, wenn Sie Klettern ausprobieren möchten oder nur kurzfristigen Zugang brauchen. Sie erhalten ab dem Aktivierungsdatum 15 Tage unbegrenzten Zugang zu allen Hallen. Der Pass ist ab Aktivierung 15 Tage gültig.',
    'faq.productChoice.punchcardBest.q': 'Wann sollte ich eine Stempelkarte wählen?',
    'faq.productChoice.punchcardBest.a': 'Wählen Sie eine Stempelkarte, wenn Sie nur gelegentlich klettern oder den Zugang mit anderen teilen möchten. Sie erhalten 10 Eintritte für alle Hallen (sofern nicht anders angegeben), die Karte ist 12 Monate gültig und Sie können innerhalb von 14 Tagen nach Ihrem letzten Stempel für 100 kr Rabatt aufladen.',
